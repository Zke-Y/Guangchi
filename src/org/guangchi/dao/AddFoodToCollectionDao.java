...
public class AddFoodToCollectionDao {

	public static void AddFoodToCollection(String fname,String Cid) {
		...
		try {
			...
			cstmt=conn.prepareCall("{call precourse_AddFoodToCollection(?,?)}");
