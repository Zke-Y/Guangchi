...
@WebServlet("/CustomerGetAnnouncementServlet")
public class CustomerGetAnnouncementServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("m-news.jsp").forward(request, response);
	}
