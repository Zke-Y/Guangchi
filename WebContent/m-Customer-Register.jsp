		...
		<div class="container clearfix">
			<div class="fr nav">
				<ul class="navbar_nav" data-in="fadeInDown" data-out="fadeOutUp">
					<li><a href="/Guangchi/m-Customer-login.jsp">返回</a></li>
				</ul>
			</div>
							...
							<form id="modifyPassword" class="form-horizontal"
								...
								<div class="form-group form-actions">
									<div class="col-xs-20 text-center">
										<input type="submit" class="btn btn-sm" value="注 册"> <input
											type="reset" class="btn btn-sm" value="重 置">
									</div>
								</div>
							</form>
						</div>
